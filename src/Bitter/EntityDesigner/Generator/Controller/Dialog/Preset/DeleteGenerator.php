...
class DeleteGenerator extends Generator implements GeneratorInterface
{
    ...
    {
        $fileName = $this->getPath() . "/controllers/dialog/" . $this->entity->getHandle() . "/preset/delete.php";
        ...
        $code .= str_repeat(" ", ($indent + 0) * $indentSize) . "use Concrete\Controller\Dialog\Search\Preset\Delete as PresetDelete;\n";
        $code .= str_repeat(" ", ($indent + 0) * $indentSize) . "use Doctrine\ORM\EntityManager;\n";
        $code .= str_repeat(" ", ($indent + 0) * $indentSize) . "\n";
        $code .= str_repeat(" ", ($indent + 0) * $indentSize) . "class Delete extends PresetDelete\n";
        $code .= str_repeat(" ", ($indent + 0) * $indentSize) . "{\n";
