...
class IconGenerator extends Generator implements GeneratorInterface
{
    ...
    {
        $fileName = $this->getPath() . "/blocks/" . $this->entity->getHandle() . "_form/icon.png";

        $fileContents = $this->fileSystem->getContents($this->pkg->getPackagePath() . "/resources/form_icon.png");
