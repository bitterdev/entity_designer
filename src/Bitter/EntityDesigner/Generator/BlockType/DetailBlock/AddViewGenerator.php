...
class AddViewGenerator extends Generator implements GeneratorInterface
{
    ...
    {
        $fileName = $this->getPath() . "/blocks/" . $this->entity->getHandle() . "_detail/add.php";
        ...
        $code .= str_repeat(" ", ($indent + 0) * $indentSize) . "\n";
        $code .= str_repeat(" ", ($indent + 0) * $indentSize) . "\$view->inc('edit.php');\n";
